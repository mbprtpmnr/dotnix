...
stdenv.mkDerivation rec {
  ...
  at = "5b3d7f5726e03a3b07b65c4f4e66717a177c310f";

  srcs = [
    (fetchurl {
      url = "https://raw.githubusercontent.com/${gh}/YosemiteSanFranciscoFont/${at}/System%20San%20Francisco%20Display%20Bold.ttf";
      name = "system-san-francisco-display-bold.ttf";
      sha256 = "08472gs6yhqzcrnhw8k2flh0sspj6bma55b295pnx1ynd2cnj8h9";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/${gh}/YosemiteSanFranciscoFont/${at}/System%20San%20Francisco%20Display%20Regular.ttf";
      name = "system-san-francisco-display-regular.ttf";
      sha256 = "0hyqs93k69ph4pddkzjxp1hn92mqmzsp97kjwgq31j82n5gsssi3";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/${gh}/YosemiteSanFranciscoFont/${at}/System%20San%20Francisco%20Display%20Thin.ttf";
      name = "system-san-francisco-display-thin.ttf";
      sha256 = "0qldanvywkpzhk29rkz1py6dkjggxmqj62qkpfxm138gv3pjf44a";
    })
    (fetchurl {
      url = "https://raw.githubusercontent.com/${gh}/YosemiteSanFranciscoFont/${at}/System%20San%20Francisco%20Display%20Ultralight.ttf";
  ...
  meta = {
    ...
    homepage = https://github.com/mbprtpmnr/YosemiteSanFranciscoFont;
